...
\dimen1=3.85in
\setbox1=\vbox{\hsize=\dimen1\strutA{\splittopskip}{0pt}{\bf Newton's Laws}
...
Momentum, energy, and angular momentum are conserved for an isolated system.  Mass is conserved in normal situations.
\smallskip
{\bf Linear Motion}
\Dis 5pt 
\baselineskip=22pt
...
\Fm \vec{p}=m\vec{v}\Mf
\Fm J_x=\int_{t_i}^{t_f}{F_x(t)\ dt}\Mf
\EndDis
{\bf Springs}
\Dis 5pt 
\baselineskip=22pt

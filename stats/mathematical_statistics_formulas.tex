...
\piflong{{\bf multiplication rule:} exp 1 has $m$ outcomes, exp 2 has $n$ outcomes, if we perform 1 then 2 then we have $mn$ outcomes.}%
\piflong{}%
\piflong{{\bf independent:} $P(A \cap B) = P(A)P(B)$}%
%
...
\def\makeandprintfullheightcols{
%split the text twice to 10.5 inches, 

\setbox40=\vsplit\bigbox to \fullcolheight
\setbox60=\hbox to \dimen1{\vbox to \fullcolheight{\unvbox40\vfill}}
\setbox41=\vsplit\bigbox to \fullcolheight
\setbox61=\hbox to \dimen1{\vbox to \fullcolheight{\unvbox41\vfill}}
